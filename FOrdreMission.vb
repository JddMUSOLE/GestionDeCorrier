...
Public Class FOrdreMission
    ...
    Sub fillGrid2()
        Try
            ...
            If (con.State = ConnectionState.Closed) Then
                con.Open()
                req = "SELECT * FROM Document WHERE CodeTypeDoc='0005'"
                cmd = New SqlCommand(req, con)
    ...
    Private Sub FOrdreMission_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        formLoadFields()
    ...
    Private Sub BtnEnregistrer_Click(sender As Object, e As EventArgs) Handles BtnEnregistrer.Click
        Try
            ...
            req = "INSERT INTO Document(NumOrdDoc,RefDoc,ConcerneDoc,DateDoc,DateReception,
                    ...
                    '" + TxtDateRecept.Value.Date + "','" + CheminAcharger + "','" + typeDocumentOM + "','" + AutoriteSign + "','" + userMat + "')"
            If (con.State = ConnectionState.Closed) Then
                con.Open()
