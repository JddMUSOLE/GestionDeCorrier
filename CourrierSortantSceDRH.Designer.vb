...
Partial Class CourrierSortantSceDRH
    ...
    Private Sub InitializeComponent()
        ...
        GroupBox1.Location = New Point(8, 118)
        ...
        BtnQuitter.Location = New Point(1140, 922)
        BtnQuitter.Name = "BtnQuitter"
        BtnQuitter.Size = New Size(188, 105)
        BtnQuitter.TabIndex = 27
        ...
        BtnAnnuler.Location = New Point(760, 922)
        BtnAnnuler.Name = "BtnAnnuler"
        BtnAnnuler.Size = New Size(188, 105)
        BtnAnnuler.TabIndex = 26
        ...
        Button1.Location = New Point(949, 922)
        ...
        BtnEnregistrer.Location = New Point(571, 922)
        ...
        dataGridCourierOrg.Location = New Point(8, 1043)
        ...
        dataGridCourierOrg.Size = New Size(1803, 760)
        dataGridCourierOrg.TabIndex = 28
        ' 
        ' Label1
        ' 
        ...
        Label1.TabIndex = 29
        Label1.Text = "COURRIERS SORTANTS ORGANE EXTERNE" & vbCrLf
        ...
        GroupBox2.Location = New Point(9, 595)
        GroupBox2.Name = "GroupBox2"
        GroupBox2.Size = New Size(1803, 309)
        ...
        BtnSelect.Location = New Point(1555, 226)
        ...
        Label13.Size = New Size(397, 61)
        Label13.TabIndex = 15
        Label13.Text = "Organe destinataire ext. :"
        ...
        TxtOrganeExpd.Location = New Point(401, 50)
        TxtOrganeExpd.Name = "TxtOrganeExpd"
        TxtOrganeExpd.Size = New Size(1387, 58)
        TxtOrganeExpd.TabIndex = 0
        ' 
        ' TxtOrganeDest
        ' 
        TxtOrganeDest.Font = New Font("Titillium Web", 9.899999F)
        TxtOrganeDest.Location = New Point(403, 109)
        TxtOrganeDest.Name = "TxtOrganeDest"
        TxtOrganeDest.Size = New Size(1385, 58)
        TxtOrganeDest.TabIndex = 4
        ' 
        ' TxtObserv
        ' 
        TxtObserv.Font = New Font("Titillium Web", 9.899999F)
        TxtObserv.Location = New Point(403, 168)
        TxtObserv.Name = "TxtObserv"
        TxtObserv.Size = New Size(1385, 58)
        ...
        TxtDocScan.Location = New Point(402, 228)
        TxtDocScan.Name = "TxtDocScan"
        TxtDocScan.Size = New Size(1154, 58)
        ...
        ' boiteDilogFichier
        ' 
        boiteDilogFichier.FileName = "OpenFileData"
        ' 
        ' CourrierSortantSceDRH
        ' 
        AutoScaleDimensions = New SizeF(17F, 41F)
        AutoScaleMode = AutoScaleMode.Font
        BackColor = SystemColors.ActiveBorder
        ClientSize = New Size(1820, 1815)
        ...
        Controls.Add(Label1)
        Name = "CourrierSortantSceDRH"
        StartPosition = FormStartPosition.CenterScreen
        Text = "CourrierSortantSceDRH"
    ...
    Friend WithEvents TxtOrganeDest As TextBox
End Class
