...
Partial Class Frecherche
    ...
    Private Sub InitializeComponent()
        ...
        dataGridCourierOrg.Location = New Point(3, 188)
        ...
        dataGridCourierOrg.TabIndex = 29
        ' 
        ' Button4
        ' 
        ...
        TxtRef.Location = New Point(573, 104)
        TxtRef.Name = "TxtRef"
        ...
        Label2.Location = New Point(271, 101)
        Label2.Name = "Label2"
        ...
        Label1.TabIndex = 22
        Label1.Text = "CONSULTATION COURRIERS PAR OBJET"
