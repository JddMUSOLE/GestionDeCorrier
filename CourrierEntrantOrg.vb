...
Public Class CourrierEntrantOrg
    ...
    Private Sub CourrierEntrantOrg_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        formLoadFields()
        formLoadFields()
        TxtNumSequence()
        fillGrid2()
    ...
    '        dataGridCourierOrg.Columns(2).Name = "Organe externe"
    '        dataGridCourierOrg.Columns(3).Name = "Agent destinateur"
    ...
    '                    dataGridCourierOrg.Rows.Add(TxtNum, txtObjet, TxtorganExt, AgtDestinateur, RefCourrier, TxtDateCourrier, TxtDateReception)
    '                End While
    ...
    Sub fillGrid2()
        Try
            ...
            dataGridCourierOrg.Columns(5).Name = "Référence courrier"
            dataGridCourierOrg.Columns(6).Name = "Date de courrier"
            dataGridCourierOrg.Columns(7).Name = "Date de reception"
            ...
            If (con.State = ConnectionState.Closed) Then
                ...
                Using Dread1 As SqlDataReader = cmd.ExecuteReader
                    While Dread1.Read()
                        ...
                        dataGridCourierOrg.Rows.Add(TxtNum, txtObjet, TxtorganExt, TxtorganDest, AgtDestinateur, RefCourrier, TxtDateCourrier, TxtDateReception)
                    End While
    ...
    Private Sub TxtAgentDest_KeyDown(sender As Object, e As KeyEventArgs) Handles TxtAgentDest.KeyDown
        If e.KeyData = Keys.Enter Then
            Try
                ...
                If (con.State = ConnectionState.Closed) Then
                    con.Open()
                    req = "SELECT Noms FROM Agent WHERE Matricule = @Noms"
                    cmd = New SqlCommand(req, con)
    ...
    Private Sub TxtObjet_KeyDown(sender As Object, e As KeyEventArgs) Handles TxtObjet.KeyDown
        If e.KeyData = Keys.Enter Then
            TxtRef.Focus()
        End If
    End Sub
    ...
    Private Sub BtnEnregistrer_Click(sender As Object, e As EventArgs) Handles BtnEnregistrer.Click
        Try
            ...
            If TxtObjet.Text = "" Or TxtRef.Text = "" Or TxtOrganeExpd.Text = "" Then
            ...
            req = "INSERT INTO Document(NumOrdDoc,RefDoc,ConcerneDoc,DateDoc,DateReception,
                    CopieInfo,Emplacement,CodeTypeDoc,Observation,OrganeExpBCC,OrganeDestBCC,
                    ...
                    '" + TxtDateRecept.Value.Date + "','" + TxtCopieInfo.Text.ToString.Trim + "','" + CheminAcharger + "','" + typeDocument + "','" + TxtObserv.Text.ToString.Trim + "','" + codeOrganeExp + "','" + codeOrganeDest + "','" + TxtAgentDest.Text.ToString.Trim + "','" + userMat + "')"
            If (con.State = ConnectionState.Closed) Then
                con.Open()
    ...
    Private Sub TxtOrganeExpd_SelectedValueChanged(sender As Object, e As EventArgs) Handles TxtOrganeExpd.SelectedValueChanged
        Try
