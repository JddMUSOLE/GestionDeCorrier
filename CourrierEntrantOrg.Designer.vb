...
Partial Class CourrierEntrantOrg
    ...
    Private Sub InitializeComponent()
        ...
        Label1.TabIndex = 13
        Label1.Text = "COURRIERS ENTRANTS ORGANES BCC" & vbCrLf
        ...
        dataGridCourierOrg.Location = New Point(7, 1111)
        ...
        BtnAnnuler.Location = New Point(688, 991)
        ...
        BtnEnregistrer.Location = New Point(499, 991)
        ...
        Button1.Location = New Point(877, 991)
        ...
        GroupBox2.Location = New Point(5, 597)
        ...
        Controls.Add(Label1)
        Name = "CourrierEntrantOrg"
        StartPosition = FormStartPosition.CenterScreen
        Text = "CourrierEntrantOrg"
