...
Public Class CourrierEntrantOrgExterne
    ...
    Private Sub CourrierEntrantOrgExterne_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        formLoadFields()
        TxtNumSequence()
        fillGrid2()
    End Sub
    ...
    Private Sub BtnEnregistrer_Click(sender As Object, e As EventArgs) Handles BtnEnregistrer.Click
        Try
            ...
            req = "INSERT INTO Document(NumOrdDoc,RefDoc,ConcerneDoc,DateDoc,DateReception,
                    CopieInfo,Emplacement,CodeTypeDoc,Observation, OrganeExterne,UserSecBCC) VALUES('" + TxtNum.Text.ToString.Trim + "','" + TxtRef.Text.ToString.Trim + "','" + TxtObjet.Text.ToString.Trim + "','" + TxtDateDoc.Value.Date + "',
                    '" + TxtDateRecept.Value.Date + "','" + TxtCopieInfo.Text.ToString.Trim + "','" + CheminAcharger + "','" + typeDocument + "','" + TxtObserv.Text.ToString.Trim + "','" + TxtOrganeExpd.Text.Trim + "','" + userMat + "')"
            If (con.State = ConnectionState.Closed) Then
                con.Open()
