...
Public Class CourrierServiceDRH
    ...
    Sub fillGrid2()
        Try
            ...
            dataGridCourierOrg.Columns(2).Name = "Service expéditeur"
            ...
            req = "SELECT * FROM DatagridSceEntrant"
            If (con.State = ConnectionState.Closed) Then
                ...
                Using Dread1 As SqlDataReader = cmd.ExecuteReader
                    While Dread1.Read()
                        ...
                        TxtSceExp = Dread1("LibService").ToString()
                        TxtorganDest = Dread1("DenominationOrgane").ToString()
                        ...
                        dataGridCourierOrg.Rows.Add(TxtNum, txtObjet, TxtSceExp, TxtorganDest, AgtDestinateur, RefCourrier, TxtDateCourrier, TxtDateReception)
                    End While
    ...
    Private Sub CourrierServiceDRH_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        formLoadFields()
        TxtNumSequence()
        fillGrid2()
    End Sub
    ...
    Private Sub TxtOrganeExpd_SelectedValueChanged(sender As Object, e As EventArgs) Handles TxtOrganeExpd.SelectedValueChanged
        Try
            ...
            If (con.State = ConnectionState.Closed) Then
                ...
                Dread = cmd.ExecuteReader()
                If (Dread.Read) Then
                    CodeService = Dread("CodeService").ToString()
    ...
    Private Sub BtnEnregistrer_Click(sender As Object, e As EventArgs) Handles BtnEnregistrer.Click
        Try
            ...
            req = "INSERT INTO Document(NumOrdDoc,RefDoc,ConcerneDoc,DateDoc,DateReception,
                    CopieInfo,Emplacement,CodeTypeDoc,Observation,SceDrh,OrganeDestBCC,
                    ...
                    '" + TxtDateRecept.Value.Date + "','" + TxtCopieInfo.Text.ToString.Trim + "','" + CheminAcharger + "','" + typeDocument + "','" + TxtObserv.Text.ToString.Trim + "','" + CodeService + "','" + codeOrganeDest + "','" + TxtAgentDest.Text.ToString.Trim + "','" + userMat + "')"
            If (con.State = ConnectionState.Closed) Then
                con.Open()
