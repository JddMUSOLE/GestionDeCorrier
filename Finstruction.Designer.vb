...
Partial Class Finstruction
    ...
    Private Sub InitializeComponent()
        ...
        BtnQuitter.Location = New Point(900, 692)
        BtnQuitter.Name = "BtnQuitter"
        BtnQuitter.Size = New Size(188, 64)
        BtnQuitter.TabIndex = 36
        ...
        BtnAnnuler.Location = New Point(520, 692)
        BtnAnnuler.Name = "BtnAnnuler"
        BtnAnnuler.Size = New Size(188, 64)
        BtnAnnuler.TabIndex = 35
        ...
        Button1.Location = New Point(709, 692)
        ...
        BtnEnregistrer.Location = New Point(331, 692)
        ...
        dataGridCourierOrg.Location = New Point(16, 767)
        ...
        dataGridCourierOrg.Size = New Size(1391, 404)
        dataGridCourierOrg.TabIndex = 32
        ' 
        ' GroupBox1
        ' 
        GroupBox1.Controls.Add(BtnSelect)
        GroupBox1.Controls.Add(TxtObserv)
        GroupBox1.Controls.Add(TxtDocScan)
        ...
        GroupBox1.Size = New Size(1385, 569)
        GroupBox1.TabIndex = 31
        GroupBox1.TabStop = False
        GroupBox1.Text = "Informations de l'instruction"
        ' 
        ' BtnSelect
        ' 
        BtnSelect.Font = New Font("Titillium Web", 9.899999F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        BtnSelect.Location = New Point(1129, 483)
        BtnSelect.Name = "BtnSelect"
        BtnSelect.Size = New Size(231, 59)
        BtnSelect.TabIndex = 34
        ...
        Label8.Location = New Point(10, 423)
        Label8.Name = "Label8"
        Label8.Size = New Size(280, 61)
        Label8.TabIndex = 28
        ...
        ' boiteDilogFichier
        ' 
        boiteDilogFichier.FileName = "boiteDilogFichier"
        ' 
        ' Finstruction
        ' 
